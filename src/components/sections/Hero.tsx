...
export default function Hero() {
  return (
    <section className="min-h-screen flex items-center relative overflow-hidden px-8 md:px-16 pt-28 pb-20"
      ...
      {/* Decorative blobs */}
      <div className="absolute top-[10%] right-[5%] w-96 h-96 rounded-[60%_40%_70%_30%/50%_60%_40%_50%] opacity-30"
      ...
      <div className="absolute bottom-[10%] left-[2%] w-72 h-72 rounded-[40%_60%_30%_70%/60%_40%_60%_40%]"
        style={{ background: 'linear-gradient(135deg, rgba(232,180,160,0.15), rgba(201,149,108,0.1))' }} />
