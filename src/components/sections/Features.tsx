const features = [
  ...
  { icon: "🩺", label: "Starter Troubleshooter", bg: "#e8f4f0", desc: "Starter smells funny? Not rising? Tell us what's going on and we'll help nurse her back to health." },
  { icon: "📖", label: "Recipe Library", bg: "#fde8e8", desc: "Loaves, rolls, focaccia, and more — each one made with real ingredients, tested in a real kitchen." },
  { icon: "🌾", label: "Flour Guide", bg: "#f5f0e8", desc: "All-purpose, whole wheat, rye — we break down every flour so you know exactly what you're working with." },
]
    ...
    <section className="py-24 px-6 bg-[#fdf6f0]">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="font-playfair text-4xl md:text-5xl font-extrabold text-[#3d2b1f]">Your full sourdough kitchen.</h2>
